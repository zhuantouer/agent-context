...
Cursor and CodeBuddy inject the protocol automatically through the plugin's always-applied rule;
Codex injects it through the plugin's `SessionStart` hook. Read the file directly when none of those apply.
